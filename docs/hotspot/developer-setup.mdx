...
Please check out the <a href="https://www.helium.com/developers" target="_blank">Helium for Developers</a> site for more information on how the rest of the system works.
...
[Consensus Protocol Design Goals](#consensus-protocol-design-goals)

[HoneyBadger BFT](#honeybadger-bft)

[The Mining Process](#the-mining-process)

[Rewarding Hotspots](#rewarding-hotspots)
...
* **Score** - Every Hotspot on the Network has a [score](/blockchain/proof-of-coverage#hotspot-scoring), ranging from `0.0` - `1.0`, that is constantly changing to reflect the network’s confidence in its asserted location. Hotspots with higher scores are more likely to be elected to a consensus group. 

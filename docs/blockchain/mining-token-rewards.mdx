...
>in order to earn HNT. Your Hotspot will perform all of the above activities on its own while it runs. That said, there are some optimizations you can 
>make to ensure your Hotspot is operating at full capacity.
...
Earning HNT consistently can be aided by ensuring a few things are ....	

...
>LongFi uses the LoRA PHY and is compatible with most certified LoRa modules such as the SX127x or SX126x from Semtech. It is a superior alternative to LoRaWAN. 

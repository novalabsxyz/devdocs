...
It’s expected that developers and manufacturers will build other “Hotspot” variants that conform to published network specifications. “Helium Hotspot” is the name of the Hotspot designed, manufactured, and distributed by Helium, Inc. You can see an interactive map of all the deployed Hotspots here.
...
LongFi uses the LoRA PHY and is compatible with most certified LoRa modules such as the SX127x or SX126x from Semtech. It is a superior alternative to LoRaWAN. Three of the biggest improvements over LoRaWAN are: 

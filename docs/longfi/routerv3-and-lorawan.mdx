...
Unfortunately, many devices do not use all 64 channels and will constraint themselves to a programmed sub-band. These devices will require a firmware update or configuation change to join the Helium network.

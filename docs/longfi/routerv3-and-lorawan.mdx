...
Other than for configuring channel mask, Adaptive Data Rate (ADR) algorithms are not implemented on RouterV3. This means that the configuration of your device is responsible for configuring it’s own Spreading Factor (SF) and power output.

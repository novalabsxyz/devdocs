...
Make sure you copy the `device id`, which will be needed when you program your device. During the duration of this beta, we will be using `OUI = 1` and a pre-shared key. 
...
The build for this project is easy! We’ll be using the stock <a href="https://www.st.com/en/evaluation-tools/b-l072z-lrwan1.html" target="_blank">STMicroelectronics B-L072Z-LRWAN1 Discovery kit</a> for reference. 
...
To learn more about our devices, visit our [Device Overview] (/Overview). 

...
If you do not see any hotspots in your area, you would need to purchase one from the <a href="https://www.helium.com/store" target="_blank">Helium Store</a> There is limited special pricing available for developers during this SDK beta, so please reach out to `developer@helium.com` before making a purchase. 

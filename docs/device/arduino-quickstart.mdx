...
> #### Important! 
> Make sure the OUI and device identifier correspond to the device details from Console. 
...
However, we are not done just yet. Now let's head back to Console and look at our device. 

...
## Connecting your B-L072Z-LRWAN1 - ST STM32L0 Discovery Board  
...
For the SDK Beta, we only support one OUI - Organizationally Unique Identifier for routing device packets. In the TransmitPacket sketch, make sure the OUI is set properly. 

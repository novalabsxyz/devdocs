...
The download comes in the form of a `stm32cubeprog.zip` file, which you'll need to unpack. 
...
Use only the default installation path: `/Applications/STMicroelectronics/STM32Cube/STM32CubeProgrammer`

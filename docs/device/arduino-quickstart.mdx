...
There are two example sketches included with the LongFi library. 
...
To learn about decoding these packets and triggering a service on IFTTT, check out this [guide] (/console/trigger-ifttt).

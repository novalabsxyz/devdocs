...
Running a Helium Miner is a great way to get some exposure to the blockchain and to support the network. And if you have your own hardware deployed \(link\), this is necessary for routing LoRaWAN packets according to our LongFi protocol.

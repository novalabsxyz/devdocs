...
| BLE Type       | Name                                 | UUID                                 | Permissions       | Data Type        | Proto Definition                                                                                                                                                     | Max Data  | Default Data | Description | Example Value                                 |
|----------------|--------------------------------------|--------------------------------------|-------------------|------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------|--------------|-------------|-----------------------------------------------|
...
| Characteristic | WiFiServices                         | d7515033-7e7b-45be-803f-c8737b171a29 | Read              | binary -> proto  | message wifi_services_v1 {    repeated string services = 1;}                                                                                                         | 512 bytes |              |             |                                               |
| Characteristic | Diagnostics                          | b833d34f-d871-422c-bf9e-8e6ec117d57e | Read              | binary -> proto  | message diagnostics_v1 {    map<string, string>diagnostics = 1;}                                                                                                     |           |              |             |                                               |
...
| Characteristic | AssertLocation                       | d435f5de-01a4-4e7d-84ba-dfd347f60275 | Read/Write/Notify | binary -> proto  | message assert_loc_v1 {    float lat = 1;    float lon = 2;    string owner = 3;    uint64 nonce = 4;    uint64 fee = 5;    uint64 amount = 6;    string payer = 7;} |           | 12 bytes     |             | "init"                                        |
| Characteristic | AddGateway                           | df3b16ca-c985-4da2-a6d2-9b9b9abdb858 | Read/Write/Notify | binary -> proto  | message add_gateway_v1 {    string owner = 1;    uint64 amount = 2;    uint64 fee = 3;    string payer = 4;}                                                         |           |              |             | "init"                                        |
| Characteristic | WiFiConnect                          | 398168aa-0111-4ec0-b1fa-171671270608 | Read/Write/Notify | binary -> proto  | message wifi_connect_v1 {    string service = 1;    string password = 2;}                                                                                            |           |              |             | "init"                                        |

...
We need to change the repo we are using for rocksdb in rebar.lock like so:
...
[global\_conf.json](https://github.com/helium/devdocs/blob/master/docs/hotspot/global_conf.json)

...
To add an **myDevices Cayenne** Integration, go to Integrations on the left menu. Select the integration to add, in this case, the **myDevices Cayenne** integration:
